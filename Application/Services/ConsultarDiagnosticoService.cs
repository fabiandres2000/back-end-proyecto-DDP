...
namespace Application.Services
{
    public class ConsultarDiagnosticoService
    {
        ...
        {
            var res = _unitOfWork.DiagnosticoRepository.FindBy(includeProperties:"Paciente,Enfermedad,Medico");
            return res.ToList();
        }
        ...
        {
            var ConsultarId = _unitOfWork.DiagnosticoRepository.FindBy(D => D.Medico.Identificacion == Identificacion, includeProperties: "Paciente,Enfermedad,Medico");
            return ConsultarId.ToList();
        }
    }
}
